...
// if Docker is unavailable, matching the mcpservers test convention.
func newTestStore(t *testing.T) (*personas.Store, func()) {
	t.Helper()
	...
	return personas.NewStore(pool), cleanup
}
